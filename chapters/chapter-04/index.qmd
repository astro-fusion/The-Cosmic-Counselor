...
- **Probabilistic Text Generators, Not Omniscient Oracles:** LLMs do not "think," "reason," or feel cosmic connection. They are sophisticated statistical prediction engines trained to output the next most plausible word (token) based on vast text datasets.
...
::: {.warning-box}
**The Astrologer's AI Rule:** AI tools excel at draft text generation, rapid planetary index summaries, and brainstorming. However, **never rely on AI for exact astronomical calculations or nuanced human empathy.** Always cross-verify AI chart outputs against astronomical ephemerides.
:::

### **Case Vignette: AI Hallucinations vs. Vedic Astrological Wisdom**

::: {.example-box}
**Scenario:** A client named Aarav entered a consultation deeply distressed. An AI astrology app had generated a Kundali analysis claiming: *"Your Rahu-Ketu placement in the 7th house creates severe Manglik and Kalasarpa Dosha, guaranteeing catastrophic failure in marriage and family business before your Rahu Dasha ends."*

- **The Unchecked AI Reality:** The AI app hallucinated non-existent planetary positions (his Rahu was actually in the 11th house) and mashed together generic fear-inducing Dosha keywords without calculating actual Dasha timings or Divisional charts (Navamsha).
- **The Cosmic Counselor's Approach:** The astrologer calmly opened his Janam Kundali using accurate ephemeris calculations, pointed out the AI's calculation errors, and explained how LLMs generate text by predicting common online phrases. The astrologer then discussed his actual 11th house Rahu placement in the context of professional networking and personal growth.  
  *Result:* Aarav experienced immense relief, understood the mechanics of AI hallucinations, and regained faith in compassionate human Jyotish counseling.
:::
...
- [ ] **Panchanaga & Ephemeris Verification:** Did I double-check all AI-generated Kundali placements, Dasha periods, and planetary degrees against authentic Panchanga/SWEPH calculations before sharing interpretations?
- [ ] **Dosha Hallucination Check:** Am I auditing AI text to ensure it hasn't fabricated fatalistic "Dosha" warnings or dramatic fear-inducing predictions?
